...
gbrStego = stegolsb(gbrlsb,namafiletxt);
        ...
        %cover image dwt2
        [i_LL,i_LH, i_HL, i_HH]=lwt2(gbrcover,lsnewInt);
        img1=i_LL;
        r1=img1(:,:,1);
        g1=img1(:,:,2);
        b1=img1(:,:,3);
        ...
        %secret image dwt2
        [i_LL,i_LH, i_HL, i_HH]=lwt2(gbrStego,lsnewInt);
        img2=i_LL;
        r2=img2(:,:,1);
        g2=img2(:,:,2);
        b2=img2(:,:,3);
        ...
        %stego dwt
        %S_wimgr=S_imgr1+S_imgr2;
        %S_wimgg=S_imgg1+S_imgg2;
        %S_wimgb=S_imgb1+S_imgb2;
        ...
        newhost_LL=wimg;
        gbrstg=(ilwt2(newhost_LL,i_LH,i_HL,i_HH,lsnewInt));
        
        %extract image
        gbrExtract=gbrstg;
        [w_LL,w_LH,w_HL,w_HH]=lwt2(gbrExtract,lsnewInt);
        img_w=w_LL;
        r3=img_w(:,:,1);
        g3=img_w(:,:,2);
        b3=img_w(:,:,3);
        ...
        S_ewatr=(S_imgr3-S_imgr1);
        S_ewatg=(S_imgg3-S_imgg1);
        S_ewatb=(S_imgb3-S_imgb1);
        ...
        newstegano_LL=ewat;
        gbrExtract=ilwt2(newstegano_LL,w_LH,w_HL,w_HH,lsnewInt);
        gbr2 = gbrExtract;
